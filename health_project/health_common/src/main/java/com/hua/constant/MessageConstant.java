...
public class MessageConstant {
    ...
    public static final String GET_SETMEAL_COUNT_SEX_SUCCESS    = "获取性别统计数据成功";
    public static final String GET_SETMEAL_COUNT_SEX_FAIL       = "获取性别统计数据失败";
    public static final String GET_SETMEAL_COUNT_AGE_SUCCESS    = "获取年龄段统计数据成功";
    public static final String GET_SETMEAL_COUNT_AGE_FAIL       = "获取年龄段统计数据失败";
